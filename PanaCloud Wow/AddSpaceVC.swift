...
class AddSpaceVC: UIViewController, UIScrollViewDelegate {
    ...
    @IBAction func create(sender: AnyObject) {
        ...
        if isAllFilled() {
            ...
            if self.isWating{
                ...
                let space1 = SpaceMetaData(spaceID: self.txtOrgID.text, desc: self.txtOrgDesc.text, title: self.txtOrgTitle.text, owner: loginUser!.uID, members: [self.txtOrgMembers.text], emailDomainRestriction : nil)

                space1.upload({ (errorDesc) -> Void in
                    ...
                    if errorDesc != nil {
                        ...
                        errorAlert.message = "Space Succefully Created"

//                        if unRegMembersUIDs == nil {
//                            errorAlert.message = "Succefully Space Created"
//                            
//                        }
//                        else if unRegMembersUIDs != nil{
//                            errorAlert.message = "Succefully Space Create \n Note: These member(s) not exist\(unRegMembersUIDs!)"
//                        }
//                        
                        ...
                        println("Succefully Space Created")
